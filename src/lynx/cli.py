...
app = typer.Typer(help="Lynx: Local Yard for Notes and eXercises")
console = Console()
...
def make_submission():
    ...
    # Example: Generate code snapshot and add to pack
    # snap_path = codesnap("src/main.py", lines=(10, 25), output_path="output/core_logic.png")
